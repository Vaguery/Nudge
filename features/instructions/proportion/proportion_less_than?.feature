Feature: proportion_less_than? instruction
  ...
  Scenario Outline: proportion_less_than?
    ...
    Examples: proportion_less_than?
    | arg1 | arg2 | instruction           | result |
    | 0.3  | 0.4  | proportion_less_than? | true   |
    | 0.4  | 0.3  | proportion_less_than? | false  |
    | 0.3  | 0.3  | proportion_less_than? | false  |
