Feature: proportion_shove instruction
  ...
  Scenario: positive pointer less than stack depth -> push the top item down N steps
    Given I have pushed ".11" onto the :proportion stack
    And I have pushed ".22" onto the :proportion stack
    And I have pushed ".33" onto the :proportion stack
    And I have pushed ".44" onto the :proportion stack
    And I have pushed ".55" onto the :proportion stack
    And I have pushed "2" onto the :int stack
    When I execute the Nudge instruction "proportion_shove"
    Then stack :proportion should have depth 5
    And the :proportion stack should be [".11", ".22", ".55", ".33", ".44"]
  ...
  Scenario: negative pointer -> do nothing
    ...
    When I execute the Nudge instruction "proportion_shove"
    Then stack :proportion should have depth 5
    And the :proportion stack should be [".11", ".22", ".33", ".44", ".55"]
  ...
  Scenario: large positive pointer -> push the top item to the bottom of the stack
    ...
    When I execute the Nudge instruction "proportion_shove"
    Then stack :proportion should have depth 5
    And the :proportion stack should be [".55", ".11", ".22", ".33", ".44"]
