Feature: *_yankdup instruction
  ...
  Scenario Outline: *_yankdup instructions
    ...
    And "<arg1>" should be in position 0 of the :<stack> stack
    And "<arg2>" should be in position 1 of the :<stack> stack
    And "<arg1>" should be in position 2 of the :<stack> stack
    And "<arg3>" should be in position 3 of the :<stack> stack
