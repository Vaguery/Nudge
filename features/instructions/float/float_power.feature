Feature: float_power instruction
  ...
  Scenario Outline: float_power
    ...
    When I execute the Nudge instruction "float_power"
    ...
    Examples: float_power emits an :error when it doesn't return a number
      | arg1  | arg2 |  result | error_msg                                  | d |
      | -12.8 | 3.1  |         | NaN: result of float_power was not a float | 0 |
      | -64.0 | 0.5  |         | NaN: result of float_power was not a float | 0 |

    Examples: float_power emits an :error when it returns Infinity
      | arg1    | arg2         |  result | error_msg                                  | d |
      | 99999.0 | 9999999999.0 |         | NaN: result of float_power was not a float | 0 |
      
    Examples: float_power emits an :error when it takes a negative exponent of 0.0
      | arg1 | arg2 |  result | error_msg                                  | d |
      | 0.0  | -3.0 |         | NaN: result of float_power was not a float | 0 |
