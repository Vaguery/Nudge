Feature: float_greater_than? instruction
  ...
  Scenario Outline: float_greater_than?
    ...
    Examples: float_greater_than?
    | arg1        | arg2 | instruction         | result |
    | 3.0         | 4.1  | float_greater_than? | false  |
    | 4.1         | 3.0  | float_greater_than? | true   |
    | 3.0         | 3.0  | float_greater_than? | false  |
    | 3.300000001 | 3.3  | float_greater_than? | true   |
    | -2.5        | 16.0 | float_greater_than? | false  |
    | -2.5        | -4.0 | float_greater_than? | true   |
