Feature: exec_yank instruction
  ...
  Scenario: positive pointer less than stack depth -> pull up item at depth N to the top
    ...
    When I execute the Nudge instruction "exec_yank"
    Then stack :exec should have depth 5
    And the :exec stack should be ["ref a", "ref b", "ref d", "ref e", "ref c"]
  ...
  Scenario: large positive pointer -> pull up the bottom item of the stack
    ...
    When I execute the Nudge instruction "exec_yank"
    Then stack :exec should have depth 5
    And the :exec stack should be ["ref b", "ref c", "ref d", "ref e", "ref a"]
