Feature: Footnotes
  ...
  Scenario: footnotes should be reassociated with value points in the code section, by type
    ...
    Then the first should be the entire script
    And the second should be "value «int» \n«int» 7"
    And the third should be "value «float» \n«float» 1.1"
  ...
  Scenario: footnotes are reassociated in order of appearance, by type
    ...
    When I ask for a list of every program point
    Then the second should be "value «int» \n«int» 88"
    And the third should be "value «float» \n«float» 1.1"
    And the fourth should be "value «bool» \n«bool» false"
    And the fifth should be "value «int» \n«int» -2"
  ...
  Scenario: scripts with missing footnotes can be parsed
    ...
    Then the second point should be "value «int» \n«int»"
